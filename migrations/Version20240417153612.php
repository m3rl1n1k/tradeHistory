 ...
 */
final class Version20240417153612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE budget (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, amout DOUBLE PRECISION DEFAULT NULL, total DOUBLE PRECISION DEFAULT NULL, public TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_73F2F77B12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE budget ADD CONSTRAINT FK_73F2F77B12469DE2 FOREIGN KEY (category_id) REFERENCES sub_category (id)');
